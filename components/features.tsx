...
const featureItems = [
  {
    ...
    description: "Golem llega a tu puerta, independientemente de donde te encuentres.",
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: "Soporte",
    description: "Te acompañamos antes y después de tu compra. Escribinos por WhatsApp si tenes dudas.",
  },
]
        ...
        <div className="container mx-auto px-4">
          ...
          <AnimateOnScroll animation="fade-up" duration={600}>
            <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-balance font-thin title-georgia">
                Nuestro trabajo
              </h2>
            ...
            {featureItems.map((feature, index) => (
              ...
              >
                <div className="text-center group">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold mb-3 font-thin title-georgia">{feature.title}</h3>
