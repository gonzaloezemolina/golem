...
export default function PreHeader() {
  ...
  return (
    <div className="w-full px-4 text-center text-white text-xs sm:text-sm font-medium tracking-widest uppercase overflow-hidden" style={{ backgroundColor: "#d29a4c" }}>
      <span
