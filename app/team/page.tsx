    ...
    <>
      ...
      <section className="relative bg-black text-white py-20 md:py-32 overflow-hidden bg-[url('/cesped.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <AnimateOnScroll animation="fade-up" duration={700} threshold={0.2}>
      ...
      <section className="bg-fondo text-white py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                >
                  {/* Team Member Image */}
                  <div className="relative h-80 md:h-96 bg-gray-900 rounded-tr-2xl rounded-bl-2xl overflow-hidden transition-all duration-300">
                  ...
                  <div className="flex flex-col gap-2">
                    <h3 className="text-xl md:text-2xl title-georgia group-hover:text-highlight transition-colors duration-300">
                      {member.name}
                    </h3>
       ...
       {/* About Us Section */}
      <section className="relative text-white bg-[url(/nosotros-segunda.jpg)] bg-cover bg-center py-16 md:py-24">
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-black/60 z-0" />
        <div className="container mx-auto px-4 relative z-10">
          {/* About Us Content - Two Column Layout */}
          <AnimateOnScroll animation="fade-right" duration={700} threshold={0.1}>
            <div className="md:gap-12 lg:gap-16 items-center mb-16 md:mb-24">
              ...
              <div className="flex flex-col gap-6">
                ...
                {/* Title */}
                <h2 className="text-4xl md:text-5xl lg:text-6xl title-georgia text-balance">
                  Pensado para todos
                </h2>
...
La accesibilidad, innovación y el detalle son nuestras bases. Pensado para todos y también para aquellos que buscan superarse e ir más allá.
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <button className="px-8 cursor-pointer py-4 bg-highlight text-white font-bold hover:bg-highlight/90 transition-all duration-300 flex items-center justify-center gap-2 group">
                    NUESTRAS REDES
                  ...
                  <a
                    ...
                    download
                    className="px-8 py-4 border-2 border-highlight text-highlight hover:bg-highlight hover:text-[#74d4ff] transition-all duration-300 font-bold flex items-center justify-center gap-2 group"
                  >
                    SABER MÁS
      ...
      <section className="bg-cover bg-center bg-no-repeat text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <AnimateOnScroll animation="zoom-in" duration={650} threshold={0.2}>
          <div className="container mx-auto px-4 text-center relative z-10">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-thin mb-6 text-balance title-georgia">
              {"Formá parte del"} <span className="text-highlight">equipo</span>
            </h2>
            <p className="mb-6 font-text">¿Te interesa unirte al proyecto?</p>

            <Link href="/contact">
              <button className="inline-flex items-center cursor-pointer gap-3 px-8 py-4 border border-highlight text-highlight font-bold hover:bg-highlight hover:text-[#74d4ff] transition-all duration-300 group">
